...
async def main():
    ...
    kids_urls = [
        ...
        # ("boys", "shorts-bottoms", "default", "default",
        #  "https://www.target.com/c/shorts-bottoms-boys-clothing-kids/-/N-5xtxx"),
        # ("boys", "swimsuits", "default", "default",
        #  "https://www.target.com/c/swimsuits-boys-clothing-kids/-/N-5xtxs"),
        # ("boys", "coats-jackets", "default", "default",
        #  "https://www.target.com/c/coats-jackets-boys-clothing-kids/-/N-5xtxv"),
        # ("boys", "pajamas-robes", "default", "default",
        #  "https://www.target.com/c/pajamas-robes-boys-clothing-kids/-/N-5xtxu"),
        # ("boys", "boys-accessories", "default", "default",
        #  "https://www.target.com/c/boys-accessories-kids/-/N-5xty9"),
        # ("boys", "socks", "default", "default",
        #  "https://www.target.com/c/socks-boys-clothing-kids/-/N-5xtxt"),
        # ("boys", "underwear", "default", "default",
        #  "https://www.target.com/c/underwear-boys-clothing-kids/-/N-5xtxm"),
        # ("boys", "activewear", "default", "default",
        #  "https://www.target.com/c/activewear-boys-clothing-kids/-/N-5xty3"),
        # ("boys", "new-arrivals", "default", "default",
        #  "https://www.target.com/c/boys-new-arrivals/-/N-kily0"),
        # ("boys", "shoes", "default", "default",
        #  "https://www.target.com/c/boys-shoes/-/N-5xtxl"),
        # ("boys", "adaptive-clothing", "default", "default",
        #  "https://www.target.com/c/boys-adaptive-clothing-kids/-/N-n2y2u"),
        ("boys", "tops", "black", "default",
         "https://www.target.com/c/tops-boys-clothing-kids/-/N-5xtxrZgup4zc5zk7s?moveTo=product-list-grid"),  # partial
        ("boys", "tops", "black", "batch1",
         "https://www.target.com/c/tops-boys-clothing-kids/-/N-5xtxrZal25lf1l7usZngyq0Zt8lsjZbkzaeZ3zu90Ztu706Zdkpd1Zal25lfju9zgZ73ee2Z88sn6ZpiwyrZ8r6cnZ4r9n4Zal25lfve9g3Zgup4zc5zk7sZlyktt?moveTo=product-list-grid"),
        ("boys", "tops", "black", "batch2",
         "https://www.target.com/c/tops-boys-clothing-kids/-/N-5xtxrZgup4zc5zk7s?moveTo=product-list-grid&sortBy=newest"),

        ("boys", "tops", "blue", "default",
         "https://www.target.com/c/tops-boys-clothing-kids/-/N-5xtxrZgup4zc5xku0?moveTo=product-list-grid"),  # partial

        ("boys", "tops", "gray", "default",
         "https://www.target.com/c/tops-boys-clothing-kids/-/N-5xtxrZgup4zc5xkum?moveTo=product-list-grid"),  # partial
        ("boys", "tops", "white", "default",
         "https://www.target.com/c/tops-boys-clothing-kids/-/N-5xtxrZgup4zc5xkwv?moveTo=product-list-grid"),  # partial
        ("boys", "tops", "green", "default",
         "https://www.target.com/c/tops-boys-clothing-kids/-/N-5xtxrZgup4zc5xkwh?moveTo=product-list-grid"),
        ("boys", "tops", "multi", "default",
         "https://www.target.com/c/tops-boys-clothing-kids/-/N-5xtxrZgup4zc5xkw9Zgup4zc5xkugZgup4zc5xktoZgup4zc5xkerZgup4zc5zk8tZesftkZgup4zc5xktmZgup4zc5xkunZgup4zc5xkwkZgup4zc5xkpk?moveTo=product-list-grid"),
        ("boys", "tops", "red", "default",
         "https://www.target.com/c/tops-boys-clothing-kids/-/N-5xtxrZgup4zc5xkvl?moveTo=product-list-grid"),

        # TODO  https://www.target.com/c/boys-character-clothing/-/N-4u9um
