...
file_path = r"E:/Tomford2"
for i in range(1, 65):
    element = driver.find_element(
        By.XPATH, '//*[@id="product-search-results"]/div/div[3]/div/div[{}]/div/div/div[1]/a[1]'.format(i)
    )
    ...
    for i in range(1, 5):
        img_url2 = tree2.xpath(
            '//*[@class="product-detail product-wrapper "]/div[1]/div[2]/div[1]/section/div[2]/div[{}]/img/@src'.format(
                i
            )
        )
