...
def run(playwright: Playwright) -> None:
    ...
    for y in range(4,10):
        page.goto(
            ...
            "&viewType=grid&keyword=%B9%FA%B7%E7&pageNo={}#anchor".format(
                y))
        # page.goto("https://login.taobao.com/member/login.jhtml?redirectURL=https%3a%2f%2fsalomon.tmall.com:443/category-1641148105.htm%2F_____tmd_____%2Fpage%2Flogin_jump%3Frand%3DS3WxGHAgAt756EpznwfNzJq2AFA2qBNla3j6EINUS8We9dazM_iKElp8DwVSHZUevpC41Bx7RzivXIj9RnZgdg%26_lgt_%3De1f50b3ed96081a28265d5a2d385a78e___247640___4cd74ece1af6c2290d81acc3ce7bf844___&uuid=e1f50b3ed96081a28265d5a2d385a78e")
        for i in range(2, 11):
            for j in range(1, 4):
                with page.expect_popup() as page1_info:
                    page.locator("#J_ShopSearchResult > div > div.shop-hesper-bd.grid > div:nth-child({}) > dl:nth-child({}) > dt".format(i, j)).first.click()
