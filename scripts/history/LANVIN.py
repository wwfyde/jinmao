...
for i in range(1, 49):
    ...
    img_name = tree2.xpath('//*[@id="shopify-section-template--17641384411382__main"]/section/div[1]/nav/ol/li[2]/a/text()')
    print(img_name)
    try:
        for i in range(1,7):
            img_url2 = tree2.xpath('//*[@id="shopify-section-template--17641384411382__main"]/section/div[3]/div[1]/div/div[{}]/div[1]/a/@href'.format(i))
