...
def run(playwright: Playwright) -> None:
    ...
    for y in range(1, 85):
        ...
        page.locator(
            "#shop-container > div.BasicLayout--mainContent--s8F4rdz > div > div.ItemList--itemList--s7z5wkA > div:nth-child(2) > div.ItemList--pagination--g5giygA > div.ItemList--pageDown--uVfM19F.false"
        ).click()
        ...
        for i in range(1, 21):
            with page.expect_popup() as page1_info:
                page.locator(
                    "#shop-container > div.BasicLayout--mainContent--s8F4rdz > div > div.ItemList--itemList--s7z5wkA > div:nth-child(2) > div.ItemList--list--mOasvFR > div:nth-child({}) > div".format(
                        i
                    )
                ).first.click()
