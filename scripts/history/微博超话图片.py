...
for i in range(1, 2000):
    ...
    url = 'https://m.weibo.cn/api/container/getIndex?extparam=%E7%A7%A6%E5%B2%9A&containerid=1008084d2c666d52eabaf2ee018a3591028edf&luicode=10000011&lfid=100103type%3D1%26q%3D%E7%A7%A6%E5%B2%9A&since_id={}'.format(since_id)#明星超话对应的js接口
    for n in news:
        # print(n)
        ...
        try:
            ...
            for detail in detail2:
                ...
                href_value2 = 'https://i0.wp.com/' + img_url[8:] #防微博图床挂了 详情：https://github.com/Semibold/Weibo-Picture-Store/issues/127
                r = requests.get(url=href_value2, headers=headers)
                with open(img_name1, 'wb') as f:
                    f.write(r.content)
                    print('{}下载完成'.format(img_name1))
