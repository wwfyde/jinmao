...
Revision ID: 4bc0d2c3e6de
Revises: 
Create Date: 2024-06-29 09:52:09.828346
...
def upgrade() -> None:
    ...
    sa.Column('outer_model_image_url', sa.String(length=1024), nullable=True, comment='外部模特图片链接'),
    ...
    sa.Column('inner_category', sa.String(length=256), nullable=True, comment='内部类别'),
    ...
    sa.Column('inner_created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=True, comment='内部创建时间'),
    sa.Column('inner_updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=True, comment='内部更新时间'),
    ...
    sa.Column('analysis', sa.JSON(), nullable=True, comment='评论分析'),
    ...
    sa.Column('product_name', sa.String(length=128), nullable=True, comment='商品名称'),
    sa.Column('gender', sa.String(length=16), nullable=True, comment='性别, 根据类别推断, 主类别'),
    sa.Column('sub_category', sa.String(length=256), nullable=True, comment='商品类别'),
    sa.Column('inner_category', sa.String(length=256), nullable=True, comment='内部类别'),
    sa.Column('size', sa.String(length=64), nullable=True, comment='尺码'),
